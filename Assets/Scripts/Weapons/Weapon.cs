...
public abstract class Weapon : MonoBehaviour
{
    ...
    protected void FireRay()
    {
        ...
        if (Physics.Raycast(ray, out hit, range, layerMask))
        {
            ...
            muzzleFlash.transform.rotation = Quaternion.LookRotation(hit.point - muzzleFlash.transform.position, Vector3.up);
        }
        else
        {
            muzzleFlash.transform.rotation = Quaternion.LookRotation(playerCamera.transform.forward, Vector3.up);
        }
